    ...
    public static void main(String[] args) {
        ...
        switch (weather) {
            ...
            case "cloudy": System.out.println("You should wear a sweater.");
                break;
            case "rainy": System.out.println("You should wear a raincoat.");
                break;
        ...
        switch (browser) {
            ...
            case "Firefox": System.out.println("The best nonprofit browser.");                
                break;
            case "Safari": System.out.println("You are using Apple?");                
                break;
            case "Edge": System.out.println("There are better browsers.");                
                break;
            case "Opera": System.out.println("This browser still exists?");                
                break;
            default: System.out.println("Curious what you are using.");
                break;
        }
